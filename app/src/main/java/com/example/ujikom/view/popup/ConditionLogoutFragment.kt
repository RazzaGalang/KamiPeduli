...
import com.example.ujikom.view.Auth.AuthActivity

class ConditionLogoutFragment : DialogFragment() {
    ...
    private fun setOutput(){
        ...
        binding.conditionTitle.text = "Keluar dari Akun"
        binding.conditionContent.text = "Apakah Anda Yakin untuk Keluar dari Akun?"
    ...
    private fun setButtonPositif(){
        binding.conditionButtonPositif.setOnClickListener {
            val rebootApp = Intent(requireContext(), AuthActivity::class.java)
            startActivity(rebootApp)
